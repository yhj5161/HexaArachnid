...
/* 软件 I2C4 引脚定义：SCL=PC4，SDA=PB0（PCA9685 #2）*/
#define HW_I2C4_SCL_PORT GPIOC
#define HW_I2C4_SCL_PIN  GPIO_Pin_4
#define HW_I2C4_SDA_PORT GPIOB
#define HW_I2C4_SDA_PIN  GPIO_Pin_0
